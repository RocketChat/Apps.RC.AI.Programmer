...
import { getDirect, sendNotification } from "../helpers/message";
...
import { IPRdetail } from "../definition/PRdetails";
...
export async function SendReminder(jobData: any, read: IRead, modify: IModify, http: IHttp, persis: IPersistence, app: AiProgrammerApp) {
  ...
  async function processReminder(reminders: IReminder[], read: IRead, app: AiProgrammerApp) {
