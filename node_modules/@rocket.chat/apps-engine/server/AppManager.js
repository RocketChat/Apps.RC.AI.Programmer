...
const AppsEngineEmptyRuntime_1 = require("./runtime/AppsEngineEmptyRuntime");
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const item of items.values()) {
                try {
                    ...
                    yield this.logStorage.storeEntries(app.getID(), app.getLogger());
                    const prl = new ProxiedApp_1.ProxiedApp(this, item, app, new AppsEngineEmptyRuntime_1.AppsEngineEmptyRuntime(app));
    ...
    disable(id, status = AppStatus_1.AppStatus.DISABLED, silent) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (AppStatus_1.AppStatusUtils.isEnabled(app.getStatus())) {
                yield app
                    .call(metadata_1.AppMethod.ONDISABLE, this.accessorManager.getConfigurationModify(app.getID()))
