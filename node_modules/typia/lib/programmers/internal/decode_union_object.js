...
var iterate = function (escaper) {
    return function (input, unions, expected) {
        return typescript_1.default.factory.createBlock([
            unions
                .map(function (u, i) {
                return typescript_1.default.factory.createIfStatement(u.is(), typescript_1.default.factory.createReturnStatement(u.value()), i === unions.length - 1 ? escaper(input, expected) : undefined);
            })
                .reverse()
                .reduce(function (a, b) {
