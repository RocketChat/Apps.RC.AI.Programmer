 ...
 * @internal
 */
var application_default_string = function (meta) {
    return function (attribute) {
        return function (schema) {
            return (0, application_default_1.application_default)(attribute)(function (str) {
                ...
                var conditions = [];
                // OTHER ATOMIC TYPES
                if (meta.atomics.find(function (a) { return a.type === "number" || a.type === "bigint"; }))
                    conditions.push(Number.isNaN(Number(str)));
                if (meta.atomics.find(function (a) { return a.type === "boolean"; }))
