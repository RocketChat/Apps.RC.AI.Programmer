    ...
    ProtobufDecodeProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name) {
                ...
                var reader = StatementFactory_1.StatementFactory.constant("reader", typescript_1.default.factory.createNewExpression(importer.use("Reader"), undefined, [
                    ...
                    : value.maps.length
                        ...
                        : value.natives.length
                            ...
                            : value.atomics.some(function (a) { return a.type === "string"; }) ||
                                value.constants.some(function (c) { return c.type === "string" && c.values.some(function (v) { return v === ""; }); }) ||
                                value.templates.some(function (tpl) { return tpl.length === 1 && tpl[0].getName() === "string"; })
