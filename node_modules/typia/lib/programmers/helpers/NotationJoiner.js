...
(function (NotationJoiner) {
    NotationJoiner.object = function (rename) {
        return function (input, entries) {
            ...
            var literal = typescript_1.default.factory.createObjectLiteralExpression(regular.map(function (entry) {
                var str = rename(entry.key.getSoleLiteral());
    ...
    NotationJoiner.tuple = function (children, rest) {
    ...
    NotationJoiner.array = function (input, arrow) {
